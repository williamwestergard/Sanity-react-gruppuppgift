...
const aboutUs = () => {
    return (
        ...
        <section className="about-us">
            ...
            <h3><img src={Trex} alt="Tyrannosaurus Rex" className="creator-icon"/>Madelen:</h3>
            <p>Front end developer student and dinosaur enthusiast!</p>
            <h3><img src={Dilophosaurus} alt="Dilophosaurus" className="creator-icon"/>William:</h3>
            <p>Front end developer and dino-expert according to no one.</p>
            <h3><img src={Velociraptor} alt="Velociraptor" className="creator-icon"/>Daniel:</h3>
            <p>Front end developer and a big fan of the velociraptor.</p>
            <h3><img src={Pteranodon} alt="Pteranodon" className="creator-icon"/>Simon:</h3>
            ...
            <p>We wanted to create a unique dinosaur website that featured a little bit of everything.</p>
            <p>Facts, fun, gamification of dinosaurs and a nice spin on interactiveness for the visitor.</p>
            <p>If you're looking for a dinosaur page that makes learning more fun, you've come to the right place!</p>
